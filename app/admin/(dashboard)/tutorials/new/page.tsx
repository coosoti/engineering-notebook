...
import { createTutorialAction } from "@/lib/actions/tutorials"
...
export default function NewTutorialPage() {
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      const result = await createTutorialAction({
        ...data,
        body: body
      })
      ...
      alert(error.message || 'An error occurred while creating the tutorial')
    } finally {
